...
console.debug("Rendering AppFull");
    ...
    <div className="planner-root">
      <header className="planner-header">
        <h1 className="planner-title">
          Garden Planner <span style={{ fontWeight: 400, fontSize: '0.7em', color: '#3AB86F' }}>(Full)</span>
        </h1>
        <div className="version-tag">Build: v1.0.2e — July 26</div>
